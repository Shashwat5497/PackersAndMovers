    ...
    <section class="section-padding-70">
        ...
        <div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<form class="registration" action="get_customer.jsp" name="studentForm" novalidate>
						...
						<input type="text" name="mobno" class="form-control margin-bottom-20">
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<input type="password" name="password" onkeyup="check();" id="txtPassword" class="form-control margin-bottom-20">
							</div>
							<div class="col-sm-6">
								<label>Confirm Password <span class="color-red">*</span></label>
								<input type="password" onkeyup="check();" id="txtConfirmPassword" class="form-control margin-bottom-20">
