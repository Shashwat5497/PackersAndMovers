...
<div id="content">
  ...
  <div class="container-fluid"><hr>
    <div class="row-fluid">
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            function ajaxFunction()
            {
                ...
                <div class="controls">
                    <select name="vehno" id="vid" onchange="ajaxFunction()">
            ...
            function ajaxFunction()
            {
                ...
                <div class="controls">
                    <select name="emp_id" id="eid" onchange="ajaxFunction1()">
	 ...
	 <div class="control-group">
                <div class="controls">
                  <label id="ajaxDiv1" style="color:red"></label>
...
<script type="text/javascript">
        ...
        var url="checkvehicle.jsp?vid="+vid;
        ajaxrequest.open("GET",url,true);
        ajaxrequest.send(null);
    }
        </script>
        ...
        ajaxrequest.onreadystatechange=function()
        {
            if(ajaxrequest.readyState===4)
            {
                var ajaxDiv=document.getElementById("ajaxDiv1");
                ajaxDiv.innerHTML=ajaxrequest.responseText;
            }
        };
        var eid=document.getElementById("eid").value;
        var url="checkemployee.jsp?eid="+eid;
        ajaxrequest.open("GET",url,true);
        ajaxrequest.send(null);
    }
        </script>
