  ...
  <div class="container-fluid"><hr>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="get_admin.jsp"  name="studentForm" novalidate  >
              <div class="control-group">
                <label class="control-label">Admin Name</label>
                <div class="controls">
                 <input type="text" name="name"  ng-model="student.name" ng-required="true" ng-minlength="5" ng-maxlength="20" />
            ...
            <span ng-show="studentForm.name.$touched && studentForm.name.$error.maxlength">Max 20 chars.</span>               
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="email" placeholder="User email" name="email"  ng-model="student.email" id="email"/>
   ...
   <span ng-show="!studentForm.password.$error.required && !studentForm.password.$error.minlength && !studentForm.password.$error.maxlength && studentForm.password.$error.pattern && studentForm.password.$dirty">Must contain one lower &amp; uppercase letter, and one non-alpha character (a number or a symbol.)</span>
               ...
               <div class="control-group">
                ...
                <div class="controls"  > 
                  <input type="text" name="mobile" id="mobile" ng-pattern="phoneNumbr" ng-model="phone" placeholder="+91-636-78658"  />
