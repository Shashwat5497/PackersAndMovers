      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="get_branch.jsp"  name="studentForm" novalidate ng-controller="mainCtrl">
              <div class="control-group">
                <label class="control-label">Branch State</label>
            ...
            function ajaxFunction()
            {
                ...
                <div class="controls">
                    <select name="txtsname" id="sid" onchange="ajaxFunction()">
		...
		<div class="control-group">
                ...
                <div class="controls">
                   <select id="ajaxDiv" name="txtcity">
                   </select>
                </div>
              </div>
              <div class="control-group">
             ...
             <div class="control-group">
                ...
                <div class="controls">
                 <input type="text" name="contact" id="contact" ng-pattern="phoneNumbr" ng-model="phone" placeholder="+91-636-78658" />
