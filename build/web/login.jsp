    ...
    <section class="section-padding-70">
        ...
        <div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                                    <form class="registration" action="check_user.jsp" method="POST">
		...
		<button type="submit" class="btn btn-primary btn-sm">Login</button>
                        ...
                        <p>no worries, <a href="forgot_password.jsp" class="color-green">click here</a> to reset your password.</p>
					</form>
				</div>
			</div>
        </div>
